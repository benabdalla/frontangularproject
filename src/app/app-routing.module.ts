...
const routes: Routes = [
  ...
  { path: 'recherche/:cle', component:   RechercheComponent},

  {path: 'test', component:   TestComponent},
  {path: 'espace_admin/dash', component:   StatistiqueComponent},
  {path: 'espace_admin/historique', component:   HistoriqueComponent},
