...
import { NavbarComponent ,DialogContentExampleDialog, DialogCRegistre} from './navbar/navbar.component';
...
import { ListercompteComponent } from './Admin/listercompte/listercompte.component';
 import { LivraisonComponent ,Confirmationlivraison} from './livraison/livraison.component';
...
import { PromotionsComponent } from './promotions/promotions.component'; // <- import OrderModule
...
@NgModule({
  ...
  entryComponents: [[NavbarComponent,  DialogContentExampleDialog,DialogCRegistre],[LivraisonComponent,Confirmationlivraison]],
  providers: [{provide: LOCALE_ID, useValue: 'fr-fr'},
  DatePipe, authInterceptorProviders,ScrollDispatcher],
